...
class Dropdown extends PureComponent {
  ...
  componentWillUpdate(nextProps) {
    if (!nextProps.open && this.props.open) {
      this._focusInDropdown =
        this.menu &&
        contains(ReactDOM.findDOMNode(this.menu), activeElement(document));
    }
  }
  ...
  renderToggle(child, props) {
    ...
    return cloneElement(child, {
      ...props,
      ref,
      onClick: chainedFunction(child.props.onClick, this.handleToggleClick),
  ...
  render() {
    ...
    return (
      <Component
        {...props}
        onMouseEnter={chainedFunction(onMouseEnter, this.handleMouseEnter)}
        onMouseLeave={chainedFunction(onMouseLeave, this.handleMouseLeave)}
